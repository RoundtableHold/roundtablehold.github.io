...
const dlc_playthrough_total = 245;
var dlc_playthrough_checked = 0;
...
const remembrances_mausoleums_total = 86;
...
if (id.startsWith("dlc_playthrough")) {
dlc_playthrough_checked += 1;
}
...
if (id.startsWith("scadutree_fragment_revered_spirit_ash")) {
